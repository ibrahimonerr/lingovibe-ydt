...
export default function ExplanationRenderer({ explanation, feedback, theme = 'amber' }: ExplanationRendererProps) {
  ...
  const anlamTheme = {
    amber: { bg: "bg-teal-50 border-teal-100 border-2", text: "text-teal-900", labelColor: "text-teal-600" },
    emerald: { bg: "bg-emerald-50 border-emerald-100 border-2", text: "text-emerald-900", labelColor: "text-emerald-600" },
    violet: { bg: "bg-violet-50 border-violet-100 border-2", text: "text-violet-900", labelColor: "text-violet-600" },
  };
