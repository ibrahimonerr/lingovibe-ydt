    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 space-y-6 animate-in zoom-in-95 duration-500 py-16">
            ...
            <div className="text-center space-y-2">
                <h2 className="text-2xl font-black text-slate-800 tracking-tight">{labTitle}</h2>
                <p className="text-sm font-medium text-slate-500">
                    Oturumu tamamladın. İşte bugünkü performansın:
                </p>
            </div>

            <div className="w-full bg-white rounded-[2.5rem] shadow-xl border-2 border-slate-100 p-8 space-y-6 relative overflow-hidden">
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-slate-50 rounded-full blur-3xl" />
                ...
                <div className="flex justify-center">
                    <div className="relative w-32 h-32 flex items-center justify-center">
                        ...
                        <div className="absolute flex flex-col items-center">
                            <span className="text-3xl font-black text-slate-800 tracking-tighter">{accuracy}%</span>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-emerald-50 rounded-2xl p-4 flex flex-col items-center border border-emerald-100">
                        ...
                        <span className="text-2xl font-black text-emerald-700">{sessionStats.correct}</span>
                        <span className="text-[10px] font-bold text-emerald-600/70 uppercase">Doğru</span>
                    </div>
                    <div className="bg-rose-50 rounded-2xl p-4 flex flex-col items-center border border-rose-100">
                        <XCircle className="text-rose-500 mb-2" size={24} />
                        <span className="text-2xl font-black text-rose-700">{sessionStats.wrong}</span>
                        <span className="text-[10px] font-bold text-rose-600/70 uppercase">Yanlış</span>
                    </div>
                </div>
            </div>
            ...
            <button 
                onClick={onFinish}
                className="w-full bg-slate-900 text-white py-5 rounded-[2.2rem] font-black uppercase text-[12px] shadow-2xl active:scale-95 transition-all flex items-center justify-center gap-2 mt-4"
            >
